 ...
 * @types: List of arguments presented
 * @buffer: Buffer array to handle the print listed
...
/************************* PRINT NON PRINTABLE *************************/
/**
 * print_non_printable - Prints ascii codes in hexa of nonprintable characters
 * @types: List of arguments presented
 * @buffer: Buffer array to handle the print listed
 * @flags:  Calculates the number of active flags
 * @width: gets the width
